...
class Actividad6View extends Component {
  loading = () => (
  ...
  async onSave(e) {
    try {
      ...
      swal({
        ...
        text: "Se guardo la actividad: 6, con id: " + respuesta[0].id,
        icon: "success",
        dangerMode: true,
        button: {
          text: "Aceptar",
      ...
      swal({
        title: "Status Actividad",
        text: "No se guardo la actividad: 6, Intenta de nuevo. ",
        icon: "error",
        dangerMode: true,
        button: {
          text: "Cerrar",
